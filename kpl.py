...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/emtcybertahsin/PAID/blob/main/PAID.txt').text
...
\033[34;1m╚═══════════════════════════════════════════════╝""")
  ...
  try:
    httpCaht = requests.get("https://github.com/emtcybertahsin/PAID/blob/main/PAID.txt").text
    if id in httpCaht:
